...
const file_proto_main_proto_rawDesc = "" +
	...
	"\n" +
	"SendNumber\x12\x19.calculator.NumberRequest\x1a\x1a.calculator.NumberResponse(\x01\x12<\n" +
...
var file_proto_main_proto_depIdxs = []int32{
	...
	1, // 2: calculator.Calculator.SendNumber:input_type -> calculator.NumberRequest
	...
	2, // 6: calculator.Calculator.SendNumber:output_type -> calculator.NumberResponse
