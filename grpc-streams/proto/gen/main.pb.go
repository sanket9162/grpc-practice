...
const file_proto_main_proto_rawDesc = "" +
	...
	"\x11GenerateFibonacci\x12\x1c.calculator.FibonacciRequest\x1a\x1d.calculator.FibonacciResponse0\x01\x12E\n" +
	"\n" +
	"SendNumber\x12\x19.calculator.NumberRequest\x1a\x1a.calculator.NumberResponse(\x01B\x13Z\x11/proto/gen;mainpbb\x06proto3"
...
var file_proto_main_proto_depIdxs = []int32{
	...
	4, // 1: calculator.Calculator.GenerateFibonacci:input_type -> calculator.FibonacciRequest
	0, // 2: calculator.Calculator.SendNumber:input_type -> calculator.NumberRequest
	3, // 3: calculator.Calculator.Add:output_type -> calculator.AddResponse
	5, // 4: calculator.Calculator.GenerateFibonacci:output_type -> calculator.FibonacciResponse
	1, // 5: calculator.Calculator.SendNumber:output_type -> calculator.NumberResponse
